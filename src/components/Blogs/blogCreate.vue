      ...
      <div class="modal-content">
          ...
          <div>
            <h6 class="text-black-50 d-inline">
              ...
              <input
                ...
                type="text"
                placeholder="Please, fill in your topic."
          ...
          <div>
            <h6 class="text-black-50 d-inline">
              ...
              <input
                class="form-control mb-3"
                type="text"
                placeholder="Please, fill in your description."
                aria-label="default input example"
          ...
          <div>
            <h6 class="text-black-50 d-inline">
              ...
              <input
                class="form-control mb-3"
                type="text"
                placeholder="Please, fill in your tags."
                aria-label="default input example"
                v-model="blog.Tags"
              />
            </h6>
        ...
        <form>
          <div class="modal-body mb-3">
                ...
                <div>
                  ...
                  <div class="mb-3">
                    <form
                      ...
                      :id="'paragraph-' + parseInt(index + 1)"
                    ></form>
                  </div>
                  <div class="d-flex justify-content-end mt-2 mb-2">
                    <button
                      class="btn btn-danger"
                      @click="deleteParagraph($event, index)"
                    >
                      Delete
                    </button>
                  </div>
            ...
            <div>
              <button
                class="btn btn-outline-dark w-100 p-3 mt-2 mb-2"
                type="button"
                @click="addParagraph"
              >
                Add Paragraph
        ...
        <div class="modal-footer">
          ...
          <button
            type="button"
            class="btn btn-primary"
            @click="createBlog(blog, paragraphs)"
          >
            Save
          </button>
        </div>
...
export default {
  ...
  methods: {
    addParagraph(event) {
      ...
      const newId = this.paragraphs.length
        ? this.paragraphs[this.paragraphs.length - 1].id + 1
        : 1;
      this.paragraphs.push({ id: newId, content: "", image: "" });
      this.$nextTick(() => {
        this.createDropzoneForParagraph(
        ...
        for (let index = 0; index < this.paragraphs.length; index++) {
          ...
          await api
            .createParagraphs({
              ...
              image: this.paragraphs[index].image
                ? uploadParagraph[0].id
                : null,
              img: this.paragraphs[index].image
                ? this.prefix + uploadParagraph[0].url
                : "",
            })
            .then((res) => {
              Swal.fire({
