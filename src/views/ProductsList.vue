...
<template>
  <div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
      <List title="Products Lists" :objectQuery="products" :deleteItem="deleteItem"
        createLink="/Products-Dashboard/create" createLinkEdit="/Products-Dashboard/edit/" :columns="[
