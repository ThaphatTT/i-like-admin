...
const handleSubmit = async () => {
    ...
    try {
        ...
        await axios.post('http://localhost:1337/api/blogs',CreateBlog,
        {
            headers: {
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Create a blog</h3></div>
                                    <div class="card-body">
                                        <form @submit.prevent="handleSubmit">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary btn-block">Add Blog</button></div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
