            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <select v-model="product.customerType" class="form-select" aria-label="Default select example">
                    ...
                    <div class="col-md-3">
                        <div class="fw-bold mb-1">Amount</div>
                            <input v-model="product.amount" class="form-control" id="inputLastName" type="text" placeholder="Input product amount." />
                    </div>
                    <div class="col-md-3">
                        <div class="fw-bold mb-1">Price</div>
                            <input v-model="product.price" class="form-control" id="inputLastName" type="text" placeholder="Input product price." />
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="fw-bold mb-1">Comments</div>
                        <textarea v-model="product.comments" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                </div>
            </div>
