        ...
        <div class="modal-body">
          ...
          <div class="row mb-3 mt-3">
            ...
            <div class="col-md-2">
              ...
              <input v-model="this.package.amount" class="form-control" id="inputLastName" type="text"
                placeholder="Input amount" />
            </div>
            <div class="col-md-2">
              <div class="fw-bold mb-1 text-star">Price</div>
              <input v-model="this.package.price" class="form-control" id="inputLastName" type="text"
